...
class ChangePassword extends Component{
    ...
    updatePassword(){
        ...
        if(newpass === confmpass){
            this.props.changePasswordAction({ oldPassword:oldpass, newPassword:newpass });
        }
                ...
                <div className= "innerPage" >
                    ...
                    <div className="panel-body">
                            <div className="form-group">
                                ...
                                name="oldpassword" id="oldpass" className="form-control" onChange={this.handleChange} value={this.state.oldpassword}></input>
                            </div>
                            <div className="form-group">
                                <label className="passwordLabel" >NewPassword</label>
                                <input type="password" placeholder="New-Password" onChange={this.handleChange} 
                            name="newpass" id="newpass" className="form-control" value={this.state.newpass}></input>
                            </div>
                            <div className="form-group">
                            ...
                            name="confmpass" id="confmpass" className="form-control" value={this.state.confmpass}></input>
                            </div>
                            <button className="btn btn-success btn-block loginbtn" onClick={this.updatePassword}>Submit</button>
                    </div>
